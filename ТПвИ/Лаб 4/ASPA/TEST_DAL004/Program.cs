...
namespace DAL004
{
	internal class Program
	{
		static void Main(string[] args)
		{
			...
			using (IRepository repository = Repository.Create("Celebrities")) // директория (в текущем директории приложения)
			{
				...
				if (repository.delCelebrityById(10000)) Console.WriteLine($" delete {10000} ");
				else Console.WriteLine($"delete {10000} error");
