...
namespace WPF_FitnessClub.Models
{
    ...
    public class UserSubscription : BaseEntity
    {
        ...
        public DateTime ExpiryDate
        {
            ...
            set
            {
                if (expiryDate != value)
                {
                    expiryDate = value;
                    OnPropertyChanged();
                    // При изменении даты истечения на текущую или прошлую - считаем абонемент отмененным, если дата обновляется не сама по себе
        ...
        // Вычисляемое свойство для проверки активности абонемента
        [NotMapped]
