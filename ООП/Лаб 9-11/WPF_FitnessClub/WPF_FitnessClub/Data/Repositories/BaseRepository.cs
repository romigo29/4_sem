    ...
    public abstract class BaseRepository<T> : IRepository<T> where T : class
    {
        ...
        public virtual void Update(T entity)
        {
            try
            {
                ...
                {
                    // Если сущность не отслеживается, присоединяем её
                    _dbSet.Attach(entity);
                }
                
                // Устанавливаем состояние как измененное
            ...
            catch (Exception ex)
            {
                ...
                throw; // Пробрасываем исключение дальше для обработки в сервисе
            }
        }
        ...
        public void Save()
        {
            try
            {
                // Обнаруживаем все изменения для гарантии
