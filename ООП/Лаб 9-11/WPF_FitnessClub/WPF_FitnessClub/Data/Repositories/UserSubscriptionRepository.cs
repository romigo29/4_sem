...
namespace WPF_FitnessClub.Repositories
{
    public class UserSubscriptionRepository
    {
        ...
        public bool CancelUserSubscription(int id)
        {
            ...
            // Флаг IsCanceled установится автоматически при изменении даты окончания
        ...
        {
            // Проверяем, есть ли в базе данных запись о том, что пользователь когда-либо приобретал этот абонемент
            return _context.UserSubscriptions
