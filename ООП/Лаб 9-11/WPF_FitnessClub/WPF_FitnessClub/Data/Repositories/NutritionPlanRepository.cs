    ...
    public class NutritionPlanRepository : BaseRepository<NutritionPlan>
    {
        ...
        public override List<NutritionPlan> GetAll()
        {
            try
            {
                ...
                // Получаем базовые данные планов питания без навигационных свойств
                ...
                {
                    // Загружаем связанных пользователей (клиент и тренер)
                    ...
                    // Создаем новую версию плана с правильно установленными навигационными свойствами
                    var nutritionPlan = new NutritionPlan
                    {
                        ...
                        Client = client,   // Устанавливаем правильное навигационное свойство Client
                        Coach = coach      // Устанавливаем правильное навигационное свойство Coach
                    };
        ...
        public List<NutritionPlan> GetByUser(int userId)
        {
            try
            {
                ...
                // Получаем планы питания для клиента
        ...
        public List<NutritionPlan> GetByTrainer(int trainerId)
        {
            try
            {
                ...
                // Получаем планы питания для тренера
        ...
        public List<NutritionPlan> GetActivePlans()
        {
            try
            {
                ...
                // Получаем активные планы питания
        ...
        public List<NutritionPlan> GetPlansByDateRange(DateTime fromDate, DateTime toDate)
        {
            try
            {
                ...
                // Получаем планы питания в указанном временном диапазоне
